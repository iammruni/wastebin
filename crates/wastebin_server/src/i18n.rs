...
static EN: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "index.toggle.visibility" => "private paste",
    "index.toggle.visibility.hint" => "places the URL under /s/ to allow restricting access",
...
static DE: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "index.toggle.visibility" => "Privater Paste",
    "index.toggle.visibility.hint" => "erstellt die URL unter /s/ zur Zugriffsbeschränkung",
